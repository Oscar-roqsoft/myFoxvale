<template>
    ...
    <!-- sidebar-wrapper -->
    <nav v-if="store.user.id" id="sidebar" class="sidebar-wrapper sidebar-dark" :class="store.menuOverlay === true ?'hide-sidebar-lg show-sidebar':'hide-sidebar show-sidebar-lg'">
