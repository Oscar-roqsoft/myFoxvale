                ...
                <ul class="list-unstyled mb-0"> 
                    ...
                    <li class="list-inline-item mb-0 ms-1">
                        <div class="dropdown dropdown-primary">
                            ...
                            <img v-if="!store.user.isAdmin" :src="store.user.profileImage ? `${store.user.profileImage}`: 'https://thumbs.dreamstime.com/z/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg?w=768'" class="avatar avatar-ex-small
                             rounded" alt="">
                            <img v-if="store.user.isAdmin" src="https://thumbs.dreamstime.com/z/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg?w=768" class="avatar avatar-ex-small
                             rounded" alt="">
                            </button>
                            <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                <nuxt-link to="/dashboard/profile" 
                                     class="dropdown-item d-flex align-items-center text-dark pb-3">
                                    <img v-if="!store.user.isAdmin"  :src="store.user.profileImage? `${store.user.profileImage}` : 'https://thumbs.dreamstime.com/z/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg?w=768'" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                    <img v-if="store.user.isAdmin" src="https://thumbs.dreamstime.com/z/default-avatar-profile-icon-vector-social-media-user-image-182145777.jpg?w=768" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
